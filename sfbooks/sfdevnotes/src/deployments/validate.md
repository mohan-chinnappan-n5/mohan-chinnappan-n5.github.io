...
![Buildings](../img/cover/chromecast-builiding-3.jpg)
...
```
- ![Deployment Valiation](https://raw.githubusercontent.com/mohan-chinnappan-n/cli-dx/master/source/img/deploy-validation-1.png)
...
### Bash script
- [Script](https://github.com/mohan-chinnappan-n/cli-dx/blob/master/source/validate.sh)
...
```
![deploy-validation-2](https://raw.githubusercontent.com/mohan-chinnappan-n/cli-dx/master/source/img/deploy-validation-2.png)
