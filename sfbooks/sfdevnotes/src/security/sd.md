...
![sd](https://github.com/mohan-chinnappan-n/cli-dx/raw/master/img/sd-1.png)

### Demo
![sd-demo](https://github.com/mohan-chinnappan-n/cli-dx/raw/master/img/sd-2.gif)
...
![viz-1](https://github.com/mohan-chinnappan-n/cli-dx/raw/master/img/userInfo.svg)
...
### Running Sharing debugger for all users

- [Get process_sharing_debug.sh](https://github.com/mohan-chinnappan-n/shell-scripts/blob/master/process_sharing_debug.sh       )

```
bash  process_sharing_debug.sh <login-user-name>
...
![All Users SD](img/sd-all-users-.png)
...
![Why this access](https://github.com/mohan-chinnappan-n/cli-dx/raw/master/sharing/img/why-user-A-has-RO-to-userB-Account-3.png)
...
```
![query account share object](https://github.com/mohan-chinnappan-n/cli-dx/raw/master/sharing/img/accountShare.webm.gif)
