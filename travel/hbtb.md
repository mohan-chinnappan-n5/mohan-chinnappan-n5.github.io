...
- For your Group, Travel Benefit may be available for traveling to BDC/BDC+/COE facilities for hip/knee/spine/cardiac/bariatric/cancer/transplant. Healthbase provides travel benefits for many Anthem Programs: Blue Distinction (BDC / BDC+), Cleveland Clinic Concierge Care (C4), Inclusive Care Program (ICP), and the Concierge Cancer Care Program (C3).
...
- You can refer a Member to Healthbase for travel logistics in two ways by secure email
