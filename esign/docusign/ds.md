...
-  Step 1. Obtain your OAuth token (```access_token```)

# Create the envelope definition

- Here we have 3 docs doc1, doc2 and doc3
...
function makeEnvelope(args){
    ...
    // ref: Auto-place (anchor tagging) - https://developers.docusign.com/docs/esign-rest-api/esign101/concepts/tabs/auto-place/
...
```js
{
  ...
  "uri": "/envelopes/bc4799a2-xxxx-xxxx-xxxx-20d1921aeb87",
  "statusDateTime": "2020-08-13T22:01:21.1300000Z",
  "status": "sent"
}
...
# References
- [eSignature REST API](https://developers.docusign.com/docs/esign-rest-api/how-to/request-signature-email-remote/)
